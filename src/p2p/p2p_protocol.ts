...
import { getTransactionPool } from '../blockchain/transaction_pool';
import { handleReceivedTransaction, getLatestBlock, getBlockchain, addBlockToChain, isValidBlockStructure, replaceChain } from '../blockchain/blockchain';
